...
source code: https://github.com/lucasresck/Search-engine. In order to run the program you should download the files on this link (the folder ``separated pages'', the file ``titles_ordered.txt'' and the file ``serialization.txt''. 
